...
void analyze_hand(int num_in_rank[], int num_in_suit[], bool *royal_straight, bool *straight, bool *ace_low, bool *flush, bool *four, bool *three, int *pairs);
void print_result(bool royal_straight, bool straight, bool ace_low, bool flush, bool four, bool three, int pairs);
...
int main(void){
	...
	for(;;){
		...
		analyze_hand(num_in_rank, num_in_suit, &royal_straight, &straight, &ace_low, &flush, &four, &three, &pairs);
		print_result(royal_straight, straight, ace_low, flush, four, three, pairs);
	}
}
